from Manager.modules.sql.translation import switch_to_locale, prev_locale
from Manager.modules.translations.strings import tld
...
def locale_button(bot, update):
    ...
    lang_match  =  re . findall (r"en|it", query.data)
    if lang_match:
        if lang_match[0]:
